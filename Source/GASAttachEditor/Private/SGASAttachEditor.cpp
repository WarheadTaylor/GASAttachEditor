		...
		[
			...
			[
				...
				(
					...
					.DefaultTooltip(LOCTEXT("GAStateTypeToolTip", "Whether the ability is active"))
					.FixedWidth(60.f)
	...
	TSharedPtr<SVerticalBox> Widget =
		...
		[
			...
			[
				...
				.DefaultLabel(LOCTEXT("GAGameplayEffectName", "Name"))
				.HAlignHeader(EHorizontalAlignment::HAlign_Center)
				...
				.DefaultLabel(LOCTEXT("GAGameplayEffectStack", "Stacks"))
				.FillWidth(0.1f)
				...
				.DefaultLabel(LOCTEXT("GAGameplayEffectGrantedTags", "Granted Tags"))
